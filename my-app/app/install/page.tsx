  ...
  return (
    <main className="flex flex-col min-h-screen items-center">
      ...
      <div className="p-10 md:px-80">
        ...
        <p className="tracking-tight py-3">Next, choose your icon size (examples below). The shortcut will start generating icons. You might have a popup appear. Press &apos;Always Allow&apos; to let the shortcut save the icon pictures. The shortcut will run and your icon pictures will be in your Photos app.</p>
